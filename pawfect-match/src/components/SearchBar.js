export default function SearchBar({ value, onChange }) {
    return (
        <div className="form-control max-xs:w-full sm:max-w-[250px]">
            <div className="input-group flex place-items-center ">
                ...
                <button className="btn btn-square xs:btn-sm border-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="lg:h-5 lg:w-5 max-xs:w-4 max-xs:h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
